...
take('taxonomy_annotation',T,'Once the capability is finalized','samples without a two-of-three consensus are excluded.')
take('transfer_heading',X,r'\section{Which generation tasks help which understanding capabilities?}')
take('transfer_scope',X,'We now evaluate the 19 I2I tasks','across its 25 understanding capabilities.')
take('taxonomy_extensions',X,'We now evaluate the 19 I2I tasks','across its 25 understanding capabilities.')
take('transfer_caption',X,'Each column corresponds to an I2I task','labeled with their gains and a star.')
...
take('related_example',X,'Counting improves with all 19 sources,','identifying and locating objects.')
...
take('cross_results',X,'Attribute editing improves category recognition','all three $p<0.01$).')
...
take('nav_transfer',X,'generation tasks help which understanding capabilities?')
